...
public class Proizvodi {
    ...
    public static String prikazProizvoda() throws ClassNotFoundException, SQLException {
        ...
        try (java.sql.Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/prodavnicaDB?autoReconnect=true&useSSL=false", "root", "pass123");) {
    ...
    public void kreiranjeProizvoda() throws ClassNotFoundException {
        ...
        try (java.sql.Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/prodavnicaDB?autoReconnect=true&useSSL=false", "root", "pass123");) {
